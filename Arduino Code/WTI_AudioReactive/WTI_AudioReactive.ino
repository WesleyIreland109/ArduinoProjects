...
//Confirmed microphone low value, and max value, changes depending on microphone used
#define MIC_LOW 0.0
#define MIC_HIGH 150.0
//How many previous sensor values effects the operating average
#define AVGLEN 5
//How many previous sensor values decides if a peak has occurred
...
//Standard deviation, changes based on mic
...
//Average sound measurement the last cycle
